...
interface AdminArchivedOnboardingPageProps {
  params: Promise<{
    organizationId: string;
  }>;
}

export default async function AdminArchivedOnboardingPage({
  params,
}: AdminArchivedOnboardingPageProps) {
        ...
        <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
          <div>
            ...
            <p className="mt-3 text-sm leading-7 text-text-secondary">
              Answers this client gave in the retired onboarding questionnaire.
              Read-only, kept for reference.
            </p>
          </div>
